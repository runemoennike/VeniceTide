...
namespace VeniceTideCommon.Code.Utils
{
	public static class BitmapFont
	{
		...
		public static void RegisterFont(string name, params int[] sizes)
		{
			...
			{
				string fontFile = "Resources/Fonts/" + name + " " + size + ".png";
				string fontMetricsFile = "Resources/Fonts/" + name + " " + size + ".xml";
				BitmapImage image = new BitmapImage();

				image.SetSource(Application.GetResourceStream(new Uri(fontFile, UriKind.Relative)).Stream);
